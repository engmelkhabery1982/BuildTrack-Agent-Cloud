...
ملفات القراءة ليست مفتوحة على كامل المشروع. قبل كل ميزة طبّق حزمة `MUST READ`
والمنع والتوسعة المشروطة المقابلة لها في
`docs/agent-work-orders/FEATURE_READ_PACKS_AR.md`. هذه الحزم جزء ملزم من أمر العمل.
