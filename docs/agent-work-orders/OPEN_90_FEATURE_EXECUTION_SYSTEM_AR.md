...
- W04–W90: `OPEN_FOR_CANDIDATE_EXECUTION`; لا تحتاج قبول Codex أو تحديث `ACTIVE.md`
  لبدء الرقم التالي، ولكن يلزم أمر المستخدم الصريح «ابدأ الميزة التالية» بعد كل handoff.
...
- بعد كل ميزة: commit مستقل ثم push إن أمكن، وتحديث
  `docs/agent-results/AGENT_QUEUE_CURSOR.md` بحد أقصى 40 سطرًا، ثم التوقف. ممنوع البدء
  التلقائي للميزة التالية؛ رسالة المستخدم وحدها تطلقها.
