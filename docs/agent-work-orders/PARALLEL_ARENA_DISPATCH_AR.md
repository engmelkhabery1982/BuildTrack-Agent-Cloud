# تشغيل Arena المتوازي — اختياري/مؤرشف

المسار الافتراضي الآن محادثة واحدة وقائمة متتابعة حسب
`UNIVERSAL_CLOUD_AGENT_PROMPT_V3_AR.md`. استخدم هذا الملف فقط إذا اختار المستخدم عمدًا
تشغيل أكثر من جلسة مستقلة.
